...
//     // Fetch user profile from http://localhost:3000/user/profile
//     const response = await fetch(`${UserProfile}/profile`, {
...
//       // Fetch leaderboard data for premium users
//       const leaderboardRes = await fetch(`${PremiumFeatureLink}/leaderboard`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
